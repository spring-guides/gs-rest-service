...
To do so, provide a Java record class or a Kotlin data class for the `id` and `content` data, as the following listing shows:
...
`src/main/kotlin/com/example/restservice/Greeting.kt`
...
Create a resource controller with the following contents:
...
`src/main/kotlin/com/example/restservice/GreetingController.kt`
...
`src/main/kotlin/com/example/restservice/RestServiceApplication.kt`
