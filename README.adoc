...
NOTE: As you see in steps below, Spring uses the https://github.com/FasterXML/jackson-docs[Jackson JSON] library to automatically marshal instances of type `Greeting` into JSON.
